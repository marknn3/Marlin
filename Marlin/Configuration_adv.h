...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 500         //ML was 500
  #define BLTOUCH_STOW_DELAY 150    //ML was 750, No need to wait for error for stow
  #define BLTOUCH_DEPLOY_DELAY 500  //ML was 750
 ...
 */
  ...
  #define MARLIN_SNAKE
  //#define MARLIN_MAZE // Not yet implemented
...
#define BABYSTEPPING  //ML
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28  //ML

  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping  //ML
  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    #define BABYSTEP_ZPROBE_GFX_OVERLAY   // ML Enable graphical overlay on Z-offset editor
  #endif
#endif
